...
class IdP(models.Model):
    ...
    associate_users = models.BooleanField(_("Associate existing users with this IdP by username"), default=True)
...
class IdPAttribute(models.Model):
    ...
    is_nameid = models.BooleanField(
        _("Is NameID"),
        default=False,
        help_text=_("Check if this should be the unique identifier of the SSO identity."),
    )
...
class IdPUser(models.Model):
    ...
    content_type = models.ForeignKey(ContentType, related_name="idp_users", on_delete=models.CASCADE)
