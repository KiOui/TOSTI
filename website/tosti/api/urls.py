...
def get_swagger_client_id():
    ...
    redirect_uris = " ".join(
        [
            ...
            for scheme, url in itertools.product(
                settings.OAUTH2_PROVIDER["ALLOWED_REDIRECT_URI_SCHEMES"], hosts
            )
        ]
    )
    ...
    swagger_oauth_client.authorization_grant_type = (
        oauth2_provider.models.Application.GRANT_IMPLICIT
    )
...
urlpatterns = [
    ...
    path(
        ...
        TemplateView.as_view(
            ...
            extra_context={
                "schema_urls": ["v1:schema-v1"],
                "swagger_oauth_client_id": get_swagger_client_id,
            },
        ),
        name="swagger",
    ),
