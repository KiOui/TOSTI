...
urlpatterns = [
    ...
    path("reservations/<int:pk>/", views.ReservationUpdateView.as_view(), name="view_reservation"),
    path("reservations/<int:pk>/delete/", views.ReservationCancelView.as_view(), name="delete_reservation"),
